...
const checkWin = ()=>{
    ...
    wins.forEach(e =>{
        if((boxtext[e[0]].innerText === boxtext[e[1]].innerText) && (boxtext[e[2]].innerText === boxtext[e[1]].innerText) && (boxtext[e[0]].innerText !== "") ){
            ...
            document.querySelector(".lingrid").style.transform = `translate(${e[3]}vw, ${e[4]}vw) rotate(${e[5]}deg)`
            document.querySelector(".lingrid").style.width = "20vw";
        }
    })
}
...
reset.addEventListener('click', ()=>{
    ...
    turn = "X"; 
    isgameover = false
    document.querySelector(".lingrid").style.width = "0vw";
    document.getElementsByClassName("info")[0].innerText  = "Turn for " + turn;
